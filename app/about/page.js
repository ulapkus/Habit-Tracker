    ...
    <div className={styles.about}>
      ...
      <div className={styles.about_main}>
        ...
        <div>
          ...
          <div className={styles.about_rabbit_container}>
            <Image
          ...
          <p className={styles.about_p}>
            Ever since I read &quot;The Power of Habit&quot; by Charles Duhigg
            in 2020, I&apos;ve been on a habit-tracking train. As a result, I
            loved tracking my habits. But I could never find a habit tracker
            online that suited my style and needs, which frustrated me. When I
            began learning to code in 2022, I was determined to build my own
            habit tracker one day, exactly as I had envisioned it. Fast forward
            to 2024, and I find myself wrapping up this project. I love that I
            have a product exactly how I like it. I use it every day!
          </p>
          <p className={styles.about_p}>
            {
